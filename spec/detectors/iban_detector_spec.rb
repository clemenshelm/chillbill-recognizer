...
describe IbanDetector do
  ...
  it "recognizes IBAN seperated by a space" do
    create(:word, text: "IBAN:", left: 1230, right: 1348, top: 3025, bottom: 3060)
    create(:word, text: "AT28", left: 1365, right: 1477, top: 3025, bottom: 3061)
  ...
  it "recognizes separated IBAN"  do
    create(:word, text: "ibon", left: 838, right: 984, top: 2550, bottom: 2606)
    create(:word, text: "AT85", left: 1029, right: 1217, top: 2537, bottom: 2605)
  ...
  it "recognizes Austrian IBAN number without space" do
    ...
    create(:word, text: 'AT851100010687868500', left: 2130, right: 2386, top: 3850, bottom: 3882)
  ...
  it 'recognizes separated iban with four digits' do
    create(:word, text: 'AT10', left: 1487, right: 2118, top: 3849, bottom: 3882)
    create(:word, text: '3225', left: 2130, right: 2386, top: 3850, bottom: 3882)
    create(:word, text: '0000', left: 2416, right: 2492, top: 3850, bottom: 3881)
